    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <a href="{{ route('notifications.index') }}" class="btn btn-primary btn-block mb-3">Back to Inbox</a>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="mailbox-read-message">
                                    ...
                                    <p>Skateboard artisan letterpress before they sold out High Life messenger bag. Bitters
                                        ...
                                        party tousled squid
                                        vinyl. Readymade next level literally trust fund. Distillery master cleanse migas,
                                        Vice sriracha
